...
export const getUserById = async (googleUserId: string): Promise<User | undefined> => {
    const getParams = {
        TableName: "Users",
        Key: {
            googleUserId
...
export const updateUser = async (googleUserId: string, userInput: Partial<User>): Promise<User> => {
